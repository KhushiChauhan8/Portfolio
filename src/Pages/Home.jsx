...
//       <div className="mt-10 relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
...
// const WORDS = ["Building Scalable Web Apps", "Tech Enthusiast"];
// const TECH_STACK = ["Javascript", "MongoDB", "Express.js", "react",  "Node.js", " Redux Toolkit / Context API", "REST API", "Git & GitHub", "Tailwind"];
// const SOCIAL_LINKS = [
//   { icon: Github, link: "https://github.com/KhushiChauhan8" },
//   { icon: Linkedin, link: "https://www.linkedin.com/in/khushi-chauhan-8a8455264 " },
//   { icon: Instagram, link: "https://www.instagram.com/khushi.dev__/" },
// ];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                {/* GIF Image */}
                <img
                  src="/Coding.gif" // Path to your GIF in the public folder
                  alt="Coding Animation"
                  className={`relative z-10 w-full h-full object-cover transform transition-transform duration-500 ${
                    isHovering ? "scale-105" : "scale-100"
                  }`}
                />
