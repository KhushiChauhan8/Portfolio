        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              I’m Khushi Chauhan, a passionate MERN Stack Developer skilled in building scalable and user-friendly web applications. I specialize in React.js, Node.js, Express, and MongoDB, with a strong focus on UI/UX, performance optimization, and state management. Constantly learning and evolving, I aim to create impactful digital solutions.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1mnbesbCOpFUGVVzOeg_JfitBUITX7xG0/view?usp=drive_link"
