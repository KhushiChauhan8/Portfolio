...
//             "& .certificate-image": { filter: "contrast(1.1) brightness(1) saturate(1.1)" },
//           },
//         }}
//       >
//         {/* Certificate Image */}
...
//           onClick={() => setOpen(true)}
//         >
//           <FullscreenIcon sx={{ fontSize: 40, color: "white", filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.2))" }} />
...
//               "&:hover": { backgroundColor: "rgba(0,0,0,0.8)", transform: "scale(1.1)" },
//             }}
//           >
//             <CloseIcon />
//           </IconButton>
//           <img src={Img} alt="Certificate Full View" style={{ maxWidth: "100%", maxHeight: "90vh", objectFit: "contain" }} />
//         </Box>
//       </Modal>
//     </Box>
//   );
